        \begin{figure*}[!t]
            ...
            \subfigure{
                \begin{minipage}[t]{0.20\textwidth}
                    \includegraphics[width=\textwidth]{fig/prior_captcha1.png}\\
                    \center (b)
                \end{minipage}
            }
            \hspace{0.16cm}
            ...
            \caption{This shows the Captchas used in prior works and current Captchas deployed in some famous websites.}
