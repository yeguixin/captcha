...
\begin{table*}
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|}
        ...
        \hline
        9 & & \multicolumn{4}{|c|}{All security features} & \\
        \hline
    \end{tabular}
\end{table*}
